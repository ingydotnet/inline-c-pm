...
if ($t2[1] eq '  -I/foo  "-I/bar   and  baa"     -I/baz  ') {
    print "ok 3\n"
}
else {
    warn "\n3\nGot:      **$t2[1]**\n",
...
if ($t2[3] eq '   -I/for-Ian "-I/for-Ingy and me"    -I/for-some-Idiocy  ') {
    print "ok 5\n"
}
else {
    warn "\n5\nGot:      **$t2[3]**\n",
...
if ($t2[4] eq '"some crap" -I-I-I -I/for-Ian -I/for-Ingy    "-I/for-some Idiocy"  -I/foo -I/bar ') {
    print "ok 6\n"
}
else {
    warn "\n6\nGot:      **$t2[4]**\n",
