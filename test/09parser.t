...
main::compile_c_code (__PACKAGE__, "foo_");

# # Use same Config options as for main::foo()
# main::compile_c_code (__PACKAGE__, "_foo_");
# 
# ########## main:_foo ########
# use Inline C => Config =>
#     DIRECTORY   => "_Inline_test",
...
# 
# main::compile_c_code (__PACKAGE__, "_foo");
# 
# ########## main:foo ########
# use Inline C => Config =>
#     DIRECTORY   => "_Inline_test",
...
#     USING       => "ParseRegExp";
# 
# main::compile_c_code (__PACKAGE__, "foo");
# 
...
#     _TESTING    => 1;
# 
# main::compile_c_code (__PACKAGE__, "bar");
# 
# ########## main:baz ########
# use Inline C => Config =>
#     DIRECTORY   => "_Inline_test",
...
#     USING       => "ParseRecDescent";
# 
# main::compile_c_code (__PACKAGE__, "baz");
# 
# ########## main:foobar ########
# # No USING value specified here - will use default (ParseRecDescent).
# use Inline C => Config =>
...
#     _TESTING    => 1;
# 
# main::compile_c_code (__PACKAGE__, "foobar");
# 
# ########## main:foobarbaz ########
# # Use same config options as for main::foobar().
# 
# main::compile_c_code (__PACKAGE__, "foobarbaz");
# 
# ########## FOO::foo ########
# package FOO;
# 
...
# 
# main::compile_c_code (__PACKAGE__, "baz_");
